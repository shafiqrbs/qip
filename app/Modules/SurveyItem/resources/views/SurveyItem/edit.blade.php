                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            @canany(['item-list'])
                        <a style="color: #000;" href="{{route('admin.surveyitem.index')}}" title="{{__('Organization::message.ListButton')}}" class="module_button_header">
                            <button type="button" class="btn btn-sm btn-outline-secondary">
                                <i class="fas fa-th-list"></i> {{__('SurveyItem::message.ListButton')}}
                            </button>
                        </a>
                            @endcan
                            <?php
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($data, ['method' => 'PATCH','autocomplete'=>'off', 'files'=> true, 'route'=> ['admin.surveyitem.update', $data->id],"class"=>"",'enctype'=>'multipart/form-data', 'id' => 'basic-form']) !!}

                            @include('SurveyItem::SurveyItem._form')

...
<div class="container">
    <div class="login-container">
        <div id="output"></div>
        <div class="avatar"><img class="logo-img" src="<?php echo e(asset('backend/image/logo.png')); ?>"></div>
        <div class="form-box">
            <form method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
                <input id="email" placeholder="User Email" type="email" class="<?php $__errorArgs = ['email'];
...
<?php /**PATH /var/www/html/survey/resources/views/frontend/layouts/welcome.blade.php ENDPATH**/ ?>